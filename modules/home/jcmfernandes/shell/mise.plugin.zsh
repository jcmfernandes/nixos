# oh-my-zsh's mise plugin, overriding the copy in the read-only nixpkgs
# oh-my-zsh: $ZSH_CUSTOM/plugins/<name> wins over $ZSH/plugins/<name> for both
# fpath and sourcing (see `_omz_source` in oh-my-zsh.sh). Verbatim upstream
# except for the `2>/dev/null` on the completion job below; keep it in sync
# when the vendored oh-my-zsh updates, and drop this file once that fix is
# upstream.
